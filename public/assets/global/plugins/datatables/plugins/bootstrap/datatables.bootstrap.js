...
$.extend(true, $.fn.dataTable.defaults, {
    "dom": "<'row.hidden-print'<'col-md-6 col-sm-6'l><'col-md-6 col-sm-6'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-5'i><'col-md-7 col-sm-7'p>>", // default layout with horizobtal scrollable datatable
    ...
    "bootstrap_extended": {
        ...
        "fnUpdate": function (oSettings, fnDraw) {
            ...
            for (i = 0, iLen = an.length; i < iLen; i++) {
                ...
                if (oPaging.iTotal <= 0) {
                    $('.dataTables_paginate, .dataTables_length .hidden-print', wrapper).hide();
                } else {
                    $('.dataTables_paginate, .dataTables_length .hidden-print', wrapper).show();
                }

                if (oPaging.iTotalPages <= 0) {
                    $('.dataTables_paginate, .dataTables_length .hidden-print .seperator', wrapper).hide();
                } else {
                    $('.dataTables_paginate, .dataTables_length .hidden-print .seperator', wrapper).show();
                }
